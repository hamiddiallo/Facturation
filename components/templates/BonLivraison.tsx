        ...
        <div className={isModern ? styles.fadyContainer : styles.invoice} style={isModern ? { width: '210mm', minHeight: '297mm', padding: '15mm', margin: '0 auto', background: 'white' } : {}}>
            {isModern ? (
                ...
                <>
                        ...
                        <tbody>
                            {data.articles.map((article, index) => (
                                <tr key={index}>
                                    ...
                                    <td style={{ textAlign: 'center' }}>{article.delivered ? 'LIVRÉ' : '—'}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                    ...
                    {/* NB Text */}
                    <div className={styles.nbText} style={{ marginTop: '2rem' }}>
                    ...
                    <footer className={styles.footer}>
                        <div className={styles.piedPage}>
                            ...
                            <div className={styles.signature}>SIGNATURE RÉCEPTIONNAIRE</div>
                        </div>
                    </footer>
                </>
            ) : (
                    ...
                    <div className={styles.middle}>
                        ...
                        <section className={styles.client}>
                            <div className={styles.dates}>
                                ...
                                <h4>Bon de Livraison N° {data.numeroFacture}</h4>
                            </div>
